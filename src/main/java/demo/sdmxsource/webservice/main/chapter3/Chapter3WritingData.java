package demo.sdmxsource.webservice.main.chapter3;
...
@Service
public class Chapter3WritingData {
	...
	public static void main(String[] args) throws IOException {
		...
		Chapter3WritingData main = 
				applicationContext.getBean(Chapter3WritingData.class);
